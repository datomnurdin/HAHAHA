...
import { Input, FormGroup, Label, Table, Button, Modal, ModalHeader, ModalBody, ModalFooter, Form} from 'reactstrap';
...
class App extends React.Component{
  ...
  loadTask(){
    axios.post('http://localhost:8890/todolist-api/get_all_tasks.php').then((response) => {
      this.setState({
  ...
  addTask(){
    axios.post("http://localhost:8890/todolist-api/create_task.php", this.state.newTaskData).then((response) => {
  ...
  updateTask(){
    ...
    axios.post("http://localhost:8890/todolist-api/update_task.php", {
  ...
  deleteTask(taskId){
    axios.post("http://localhost:8890/todolist-api/delete_task.php", {taskId}).then((response)=> {
      this.loadTask()
    })
  }
      ...
      <div className="App container">
        ...
        <Button color="primary" 
          ...
          <Modal isOpen={this.state.editTaskModal} 
            ...
            <ModalFooter>
              <Button color="primary" 
                onClick={this.updateTask.bind(this)}>Edit Task</Button>{''}
              <Button color="secondary" 
                onClick={this.toggleNewTaskModal.bind(this)}>Cancel</Button>
            </ModalFooter>
          </Modal>
